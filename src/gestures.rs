...
lazy_static! {
    static ref GESTURES: Vec<(&'static str, PreparedGesture)> = vec![
        ...
        ("square",         gesture![(   0.0,    0.0), ( 100.0,    0.0), ( 100.0,  100.0), (   0.0,  100.0),
                                    (   0.0,    0.0),                                                     ]),

        ("square",         gesture![(   0.0,    0.0), (   0.0,  100.0), ( 100.0,  100.0), ( 100.0,    0.0),
                                    (   0.0,    0.0),                                                     ]),

        ("circle-cw",      gesture![(   0.0, -100.0), (  70.7,  -70.7), ( 100.0,    0.0), (  70.7,   70.7),
                                    (   0.0,  100.0), ( -70.7,   70.7), (-100.0,    0.0), ( -70.7,  -70.7),
                                    (   0.0, -100.0),                                                     ]),

        ("circle-ccw",     gesture![(   0.0, -100.0), ( -70.7,  -70.7), (-100.0,    0.0), ( -70.7,   70.7),
                                    (   0.0,  100.0), (  70.7,   70.7), ( 100.0,    0.0), (  70.7,  -70.7),
                                    (   0.0, -100.0),                                                     ]),
    ];
}
